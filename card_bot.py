...
bot = TeleBot(token='5735553786:AAFbGxGjFmyqKh1gf5c1x_k620PTPMzS_R8', parse_mode='html') # создание бота
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Если тебе необходимо сгенерировать номер тестовой банковской карты, то я могу помочь\nВыбери тип карты:', # текст сообщения
